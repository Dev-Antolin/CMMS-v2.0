<%@ Control Language="VB" AutoEventWireup="false" CodeFile="RCTDesignation.ascx.vb" Inherits="UserControl_RCTDesignation" %>
        ...
        <tr>
            <td class="style2">
                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                    TargetControlID="txtSearchRCT" FilterType="UppercaseLetters,LowercaseLetters,Custom"
                    ValidChars=" .-ñ" />
                <asp:TextBox ID="txtSearchRCT" CssClass="WriteBackColor" runat="server" Width="225px" Style="text-transform: uppercase;"></asp:TextBox>
                <ajaxToolkit:TextBoxWatermarkExtender ID="txtSearchRCT_TextBoxWatermarkExtender" 
                    runat="server" Enabled="True" TargetControlID="txtSearchRCT"
                    WatermarkCssClass="watermarked" WatermarkText="RCT Name">
...
<div class="GVData">
    <asp:GridView ID="gvBranch" runat="server" AutoGenerateColumns="False" CellPadding="4"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Fullname" HeaderText="RCT Name">
