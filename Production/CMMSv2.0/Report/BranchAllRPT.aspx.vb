...
Partial Class Report_BranchAllRPT
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        Else
            Me.rptViewer.ReportSource = Me.Session("AllBranchAssetP")
        End If
        'GenerateReport()
    End Sub
    ...
    '    Try
    '        myReport.Load(AppDomain.CurrentDomain.BaseDirectory + "CrystalRPT\BranchAllAssetProfile.rpt")
    ...
    '        'myRPT = "call SPBraAllAssProf('" & DateFrom & "','" & DateTo & "','" & ByBra & "');"
