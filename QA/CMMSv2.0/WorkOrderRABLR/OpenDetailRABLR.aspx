<%@ Page Title="" Language="VB" MasterPageFile="~/LeftWORABLRMainMasterPage.master"
    AutoEventWireup="false" CodeFile="OpenDetailRABLR.aspx.vb" Inherits="WorkOrder_OpenDetailRABLR" %>
    ...
    <asp:UpdatePanel runat="server" ID="UpdateFace">
        <ContentTemplate>
            <div id="main-copy">
                ...
                <asp:Panel ID="PanelWorkOrderInfo" runat="server" GroupingText="Work Order Information"
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEscalationName" CssClass="ReadOnlyBackColor" runat="server" 
                ...
                <asp:Panel ID="PanelAssessment" runat="server" GroupingText="Assessment" Width="600px">
                    <table style="width: 100%">
                        <tr>
                            <td style="width: 143px" align="right">
                                &nbsp; &nbsp;</td>
                            <td rowspan="7">
                                <asp:TextBox ID="txtAssessment" runat="server" Height="160px"
                                    TextMode="MultiLine" Width="430px" MaxLength="300"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 143px">
                        ...
                        <tr>
                            <td style="width: 143px">
                                &nbsp;</td>
                            <td align="right">
                                <asp:Label ID="lblCount" runat="server" ForeColor="Blue" Text="500/500"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 143px">
                            ...
                            <td>
                                <asp:Button ID="btnCloseAst" runat="server" Text="Close Work Order" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 143px">
