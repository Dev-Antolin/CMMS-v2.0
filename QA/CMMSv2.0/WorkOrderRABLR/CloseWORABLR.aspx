<%@ Page Title="" Language="VB" MasterPageFile="~/LeftWORABLRMainMasterPage.master"
    AutoEventWireup="false" CodeFile="CloseWORABLR.aspx.vb" Inherits="WorkOrderRABLR_CloseWORABLR" %>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td align="left" style="width: 520px">
                        ...
                        <asp:Button ID="btnSearchWO" runat="server" Text="Search" />
                    </td>
                    <td>
                        &nbsp;
                    </td>
                ...
                <tr>
                    <td colspan="3">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:Label ID="lblSearchError" runat="server" Font-Size="Small" ForeColor="Blue"></asp:Label>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                    <td style="width: 75px" align="right">
