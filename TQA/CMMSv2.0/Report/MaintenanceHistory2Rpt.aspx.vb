...
Partial Class Report_MaintenanceHistory2Rpt
    ...
    Private Sub GenerateReport()
        ...
        DateFrom = Me.Session("FromAll")
        DateTo = Me.Session("ToAll")

        Try
            myRPT = "call SPDivMainHistory('" & DateFrom & "','" & DateTo & "');"
            ds = Execute_DataSetCMMS(myRPT)
            If Not ds Is Nothing Then
                dt = ds.Tables(0)
            End If
            myReport.Load(AppDomain.CurrentDomain.BaseDirectory + "CrystalRPT\DivisionMaintenHis.rpt")
