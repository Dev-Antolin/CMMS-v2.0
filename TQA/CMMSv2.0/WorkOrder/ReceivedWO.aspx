<%@ Page Title="" Language="VB" MasterPageFile="~/LeftWOMainMasterPage.master" AutoEventWireup="false"
    CodeFile="ReceivedWO.aspx.vb" Inherits="WorkOrder_ReceivedWO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CMMSMainContentPlaceHolder" runat="Server">
    ...
    <%--    <script language="javascript" type="text/javascript">
        ...
        function keyhandler(e) {
            ...
            var obj = document.getElementById('<%=Button1.ClientId%>');
            ...
            <table style="width: 100%; height: 44px;">
                <tr>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <%--                                <asp:FilteredTextBoxExtender ID="txtSearchWONo_FilteredTextBoxExtender" runat="server"
                                    Enabled="True" TargetControlID="txtSearchWONo" FilterType="UppercaseLetters,LowercaseLetters,Numbers,Custom"
                                    ValidChars="-">
                    ...
                    <td align="left" style="width: 520px">
                        <asp:DropDownList ID="ddlSearchMonth" CssClass="WriteBackColor" runat="server" TabIndex="4">
                        ...
                        <asp:Button ID="btnSearchWO" runat="server" Text="Search" TabIndex="2" />
                    </td>
                    <td>
                        &nbsp;
                    </td>
            ...
            <ContentTemplate>
                <asp:GridView ID="gvReceivedDetails" runat="server" AutoGenerateColumns="False" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Escalated_By" HeaderText="Escalated by" />
                    </Columns>
