<%@ Page Title="" Language="VB" MasterPageFile="~/LeftWORABLRMainMasterPage.master"
    AutoEventWireup="false" CodeFile="ReceivedDetailRABLR.aspx.vb" Inherits="WorkOrder_ReceivedDetailRABLR" %>
                ...
                <asp:Panel ID="PanelAssessment" runat="server" GroupingText="Service Call Ticket"
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnSaveAst" runat="server" Text="Save" />
                                <asp:Button ID="btnCloseAst" runat="server" Text="Resolve" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 143px">
